<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:72:"/www/ginco/ginco-admin/public/../application/admin/view/index/index.html";i:1580299046;s:62:"/www/ginco/ginco-admin/application/admin/view/common/meta.html";i:1580299046;s:64:"/www/ginco/ginco-admin/application/admin/view/common/header.html";i:1583209137;s:62:"/www/ginco/ginco-admin/application/admin/view/common/menu.html";i:1580302754;s:65:"/www/ginco/ginco-admin/application/admin/view/common/control.html";i:1580299046;s:64:"/www/ginco/ginco-admin/application/admin/view/common/script.html";i:1580299046;}*/ ?>
<!DOCTYPE html>
...
<a href="javascript:;" class="logo">
    <!-- 迷你模式下Logo的大小为50X50 -->
    <span class="logo-mini"><?php echo htmlentities(mb_strtoupper(mb_substr($site['name'],0,5,'utf-8'),'utf-8')); ?></span>
    <!-- 普通模式下Logo -->
    <span class="logo-lg"><b><?php echo htmlentities(mb_substr($site['name'],0,5,'utf-8')); ?></b><?php echo htmlentities(mb_substr($site['name'],5,null,'utf-8')); ?></span>
</a>
                        ...
                        <li class="user-body">
                            <div class="row">
                                <div class="col-xs-12 text-center">
                                    <p>Give you the ultimate experience</p>
                                </div>
