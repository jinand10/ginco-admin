<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/www/ginco/ginco-admin/public/../application/admin/view/banner/banner/edit.html";i:1587659685;s:65:"/www/ginco/ginco-admin/application/admin/view/layout/default.html";i:1580299046;s:62:"/www/ginco/ginco-admin/application/admin/view/common/meta.html";i:1580299046;s:64:"/www/ginco/ginco-admin/application/admin/view/common/script.html";i:1580299046;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_select('row[module]', $moduleList, $row['module'], ['class'=>'form-control selectpicker', 'data-rule'=>'required']); ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_select('row[article_id]', $articleList, $row['article_id'], ['class'=>'form-control selectpicker', 'data-rule'=>'required']); ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input placeholder="建议图片尺寸720*350哦~" id="c-cover" data-rule="required" class="form-control" size="50" name="row[cover]" type="text" value="<?php echo $row['cover']; ?>">
    ...
    <div class="form-group">
        <label placeholder="建议图片尺寸720*350哦~" for="c-english_cover" class="control-label col-xs-12 col-sm-2"><?php echo __('EnglishCover'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-english_cover" data-rule="required" class="form-control" size="50" name="row[english_cover]" type="text" value="<?php echo $row['english_cover']; ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input placeholder="升序排序~" id="c-sort" data-rule="required" class="form-control" name="row[sort]" type="number" value="<?php echo $row['sort']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('IsShow'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[is_show]', ['0'=>__('False'), '1'=>__('True')], $row['is_show']); ?>
        </div>
    </div>
