define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'single/config/index',
                    add_url: 'single/config/add',
                    edit_url: 'single/config/edit',
                    del_url: 'single/config/del',
                    multi_url: 'single/config/multi',
                    table: 'config',
                }
            });
