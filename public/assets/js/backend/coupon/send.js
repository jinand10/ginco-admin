define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'coupon/send/index',
                    add_url: 'coupon/send/add',
                    edit_url: 'coupon/send/edit',
                    del_url: 'coupon/send/del',
                    multi_url: 'coupon/send/multi',
                    table: 'api_user_coupon',
                }
            });
